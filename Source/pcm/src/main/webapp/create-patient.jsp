...
<input type="text" id="Editbox5" style="position:absolute;left:395px;top:204px;width:148px;height:20px;border:1px #C0C0C0 solid;font-family:'Courier New';font-size:16px;z-index:2" name="Editbox5" value="" maxlength="20">
<div id="bv_Text5" style="margin:0;padding:0;position:absolute;left:275px;top:206px;width:103px;height:16px;text-align:left;z-index:3;">
<font style="font-size:13px" color="#000000" face="Arial">&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; Last Name</font></div>
<input type="text" id="Editbox6" style="position:absolute;left:152px;top:164px;width:148px;height:20px;border:1px #C0C0C0 solid;font-family:'Courier New';font-size:16px;z-index:4" name="Editbox6" value="" maxlength="20">
<input type="password" id="Editbox7" style="position:absolute;left:153px;top:201px;width:148px;height:20px;border:1px #C0C0C0 solid;font-family:'Courier New';font-size:16px;z-index:5" name="Editbox7" value="">
<div id="bv_Text8" style="margin:0;padding:0;position:absolute;left:35px;top:242px;width:103px;height:16px;text-align:left;z-index:6;">
<font style="font-size:13px" color="#000000" face="Arial">&nbsp;&nbsp; &nbsp;&nbsp; Date Of Birth</font></div>
<div id="bv_Text9" style="margin:0;padding:0;position:absolute;left:35px;top:277px;width:103px;height:32px;text-align:left;z-index:7;">
<font style="font-size:13px" color="#000000" face="Arial">&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; Address</font></div>
<input type="text" id="Editbox8" style="position:absolute;left:154px;top:238px;width:148px;height:20px;border:1px #C0C0C0 solid;font-family:'Courier New';font-size:16px;z-index:8" name="Editbox8" value="" maxlength="20">
<input type="text" id="Editbox9" style="position:absolute;left:155px;top:275px;width:148px;height:20px;border:1px #C0C0C0 solid;font-family:'Courier New';font-size:16px;z-index:9" name="Editbox9" value="" maxlength="20">
<input type="password" id="Editbox10" style="position:absolute;left:396px;top:238px;width:148px;height:20px;border:1px #C0C0C0 solid;font-family:'Courier New';font-size:16px;z-index:10" name="Editbox10" value="" maxlength="20">
<input type="text" id="Editbox11" style="position:absolute;left:397px;top:275px;width:148px;height:20px;border:1px #C0C0C0 solid;font-family:'Courier New';font-size:16px;z-index:11" name="Editbox11" value="" maxlength="20">
<div id="bv_Text10" style="margin:0;padding:0;position:absolute;left:277px;top:242px;width:103px;height:16px;text-align:left;z-index:12;">
<font style="font-size:13px" color="#000000" face="Arial">&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; SSN</font></div>
<div id="bv_Text11" style="margin:0;padding:0;position:absolute;left:277px;top:277px;width:103px;height:32px;text-align:left;z-index:13;">
<font style="font-size:13px" color="#000000" face="Arial">&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; Phone</font></div>
<div id="bv_Text12" style="margin:0;padding:0;position:absolute;left:36px;top:312px;width:103px;height:16px;text-align:left;z-index:14;">
<font style="font-size:13px" color="#000000" face="Arial">&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; Email Id</font></div>
<input type="text" id="Editbox12" style="position:absolute;left:156px;top:310px;width:148px;height:20px;border:1px #C0C0C0 solid;font-family:'Courier New';font-size:16px;z-index:15" name="Editbox12" value="" maxlength="20">
<div style="position:absolute;left:398px;top:313px;width:148px;height:18px;border:1px #C0C0C0 solid;z-index:16">
