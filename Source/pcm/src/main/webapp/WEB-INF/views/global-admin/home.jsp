...
<body>
	...
	<div id="container">
		<div id="Html1"
			style="position: absolute; left: 6px; top: 46px; width: 994px; height: 873px; z-index: 3">
		</div>
		<div id="bv_Form1"
			...
			<form name="HospitalAdmin" method="post" action=""
				...
				<div id="bv_Text2"
					style="margin: 0; padding: 0; position: absolute; left: 171px; top: 110px; width: 193px; height: 22px; text-align: left; z-index: 1;">
					<font style="font-size: 19px" color="#000000" face="Arial"><b>Welcome Admin ${userAccount.username}</b></font>
				</div>
				<div id="bv_TextMenu1"
