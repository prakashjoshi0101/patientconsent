...
<h5>Update Consent</h5></div>
<div style="position:absolute;left:313px;top:134px;width:148px;height:18px;border:1px #C0C0C0 solid;z-index:2">

<form:select path="recordType" name="recordType" multiple size="1" id="Combobox1" style="position:absolute;left:0px;top:0px;width:100%;height:100%;border-width:0px;font-family:'Courier New';font-size:16px;">
...
<input type="submit" id="Button1" name="update consent" value="update consent" style="position:absolute;left:220px;top:302px;width:136px;height:24px;font-family:Arial;font-size:13px;z-index:3">
...
<font style="font-size:13px" color="#000000" face="Arial">Consent Type</font></div>
<div style="position:absolute;left:315px;top:216px;width:148px;height:18px;border:1px #C0C0C0 solid;z-index:6">

<form:select path="consentType" name="consentType" multiple size="1" id="Combobox2" style="position:absolute;left:0px;top:0px;width:100%;height:100%;border-width:0px;font-family:'Courier New';font-size:16px;">
